...
from fastapi import APIRouter, Query, status  # noqa
...
@router.post("/send", status_code=status.HTTP_200_OK, response_model=EmailSendResponse)
async def send_email(
    ...
    if email_data.email_type == EmailType.PASSWORD_RESET:
        # TODO: implement password reset email task
        pass

    if email_data.email_type == EmailType.NOTIFICATION:
        # TODO: implement notification email task
        pass
...
async def get_email_task_status(task_id: str):
